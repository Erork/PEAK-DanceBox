...
public sealed partial class Plugin
{
    ...
    private void DrawSettingsWindow(int id)
    {
        ...
        GUILayout.Label("DanceBox", titleStyle!, GUILayout.Height(42f));
        GUILayout.FlexibleSpace();
        GUILayout.Label("2.0.8", mutedStyle!, GUILayout.Width(90f));
